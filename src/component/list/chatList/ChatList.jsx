...
console.log(chatId)
    ...
    // const filteredChats = input ? chats.filter((c)=c.user.username.toLowerCase().includes(input.toLowerCase())) : chats;

    const filteredChats = input
  ? chats.filter((c) => c.user && c.user.username.toLowerCase().includes(input.toLowerCase()))
  : chats;
